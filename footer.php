        ...
        <div class="footer__links">
            <div class="footer__link--wrapper">
                <div class="footer__link--items">
                    <h2>About Us</h2>
                    <a href="/sign__up">How it works</a> <a href="/">Sem Piekar</a>
                    <a href="/">Stefano Koster</a> <a href="/">Ambriël Lourents
                    </a>
                    <a href="/">Timothy Hoogeveen</a>
                </div>
                <div class="footer__link--items">
                    <h2>Contact Us</h2>
        ...
        <section class="social__media">
            <div class="social__media--wrap">
                <div class="footer__logo">
                    <a href="/" id="footer__logo"><i class="fa-solid fa-gamepad"></i>Team A</a>
                </div>
                <p class="website__rights">© PROJECT GAMES 2022. All rights reserved</p>
